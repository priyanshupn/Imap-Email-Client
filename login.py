...
class LOGIN_UI:
    ...
    def __setup_layout(self, email, password, isEdit=None):
        ...
        self.__stdscr.clear()
        utils.title(self.__stdscr, "LOGIN")
        ...
        # setup bottom bar
        Bottom_Line(self.__stdscr, self.__options)
    ...
    def __authenticate(self, email, password):
        ...
        try:
            ...
            utils.show_msg_status(self.__stdscr, str(e), time_to_show=3)
